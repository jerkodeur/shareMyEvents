package co.simplon.p25.sharemyeventsapi.config;
...
import co.simplon.p25.sharemyeventsapi.exceptions.RestTemplateErrorHandler;

@Configuration
public class RestTemplateConfig {

	@Value("${sharemyevents.api.access.url}")
