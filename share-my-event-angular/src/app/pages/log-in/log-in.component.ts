...
export class LogInComponent {
  ...
  onSubmit = (): void => {
    ...
    if (this.loginForm.invalid) {
      ...
      return;
    } else if(this.loginForm.value.email !== this.testEmail || this.loginForm.value.password !== this.testPassword) {
      this.noMatch = true;
      this.loginForm.reset();
      this.submitted = false;
      return this.flashService.flash$.next({ errors: true, message: "Les identifiants renseignés ne sont pas valides." });
    }
