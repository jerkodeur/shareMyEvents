...
const routes: Routes = [
  ...
  {
    path: "password-reset/init", component: ResetPasswordInitComponent
  },
  {
    path: "password-reset/instructions", component: ResetPasswordInstructionsComponent
  },
  {
    path: "password-reset", component: ResetPasswordPageComponent
  },
  {
